...
echo 开始处理Jmeter文件
find ../src | grep .jmx | xargs grep "HTTPSampler.path" > ../out/all/tmp/interfacelist-tmp
./handle-jmeter-interface.sh all ../out/all/tmp/interfacelist-tmp ../out/all/jmeter-interfacelist
...
# 开始计算整体覆盖率
echo 合并文件
cat ../out/all/jmeter-interfacelist ../out/yapi-interfacelist > ../out/all/tmp/merge
...
cat ../out/yapi-interfacelist ../out/all/jmeter-match-in-yapi > ../out/all/tmp/merge3
